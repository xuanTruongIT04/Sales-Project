        ...
        <div class="card">
            ...
            <div class="card-header font-weight-bold d-flex justify-content-between align-items-center">
                <div id="title-btn-add">
                    ...
                    <a href="{{ route("admin.page.add") }}" class="btn btn-primary ml-3">THÊM MỚI</a>
                </div>
                                ...
                                @foreach ($pages as $page)
                                    ...
                                    <tr class="row-in-list">
                                        ...
                                        <td><a class="text-primary"
                                                href="{{ route('admin.page.edit', $page->id) }}">{{ $page->page_title }}</a>
                                        </td>
                                        <td>{{ $page->slug }}</td>
                                        <td>{!! date("H:i:s-d/m/Y", strtotime($page->created_at)) !!}</td>
                                        <td>{!! field_status($page->page_status) !!}</td>
